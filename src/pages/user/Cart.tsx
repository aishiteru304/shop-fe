...
export default function Cart() {
    ...
    const handleChangeAmount = (x: number) => {
        setTotalAmount(totalAmount => totalAmount + x)
    }

    const handleChangePrice = (x: number) => {
                    ...
                    if (amountElement) {
                        if (amountElement.textContent) {
                            ...
                            if (parseInt(amount) > 0) {
                                ...
                                if (priceElement && priceElement.textContent && imageElement) {
                ...
                {userCart[0] ?
                    <div className="my-4 flex gap-3 flex-wrap mb-8">
                        ...
                        <div className="w-full max-w-md  mx-auto mb-4">
                            ...
                            <button onClick={handlePayment} className="bg-red-500 w-full text-lg font-bold py-2 text-white">
                                Payment
                            </button>
                        </div>
                    </div>
